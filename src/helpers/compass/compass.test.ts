...
describe('Bad bearing values', () => {
    test('Repeated bearing values are ignored', () => {
        const badCompass = new Compass(['North, North, North'])
        expect(badCompass.length).toBe(1)
    })
})